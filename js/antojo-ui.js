...
import { CRAVINGS, MOODS, HUNGER, SLEEP, explain, cost, alternatives, portionOf, smallerPortion, cravingStats, analyzeCravings, BLOCKS, cravingQuality, swapFor, satiety, minutesText } from './antojo.js?v=0.8.1';
import { TYPES, QLABEL, bodyZones, foodQuality, tagLine } from './calidad.js?v=0.8.1';
import { bodySvg, ZONE_NAMES } from './cuerpo.js?v=0.8.1';
