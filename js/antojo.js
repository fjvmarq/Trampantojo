...
import { FOODS_BY_ID, nutrientsFor } from './foods.js?v=0.10.0';
import { foodQuality, TYPES } from './calidad.js?v=0.10.0';
import { ACT_BY_ID, burned } from './ejercicio.js?v=0.10.0';
