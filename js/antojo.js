...
import { FOODS_BY_ID, nutrientsFor } from './foods.js?v=0.9.1';
import { foodQuality, TYPES } from './calidad.js?v=0.9.1';
import { ACT_BY_ID, burned } from './ejercicio.js?v=0.9.1';
