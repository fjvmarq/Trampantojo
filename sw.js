...
const CACHE = 'trampantojo-0.11.0';
...
const FILES = [
  './',
  'index.html',
  'css/app.css?v=0.11.0',
  'js/app.js?v=0.11.0',
  'js/ambient.js?v=0.11.0',
  'js/foods.js?v=0.11.0',
  'js/comidas.js?v=0.11.0',
  'js/antojo.js?v=0.11.0',
  'js/antojo-ui.js?v=0.11.0',
  'js/ideas.js?v=0.11.0',
  'js/logros.js?v=0.11.0',
  'js/calidad.js?v=0.11.0',
  'js/cuerpo.js?v=0.11.0',
  'js/ejercicio.js?v=0.11.0',
  'js/copia.js?v=0.11.0',
  'js/agua.js?v=0.11.0',
  'js/menu.js?v=0.11.0',
  'js/calendario.js?v=0.11.0',
  'js/fotos.js?v=0.11.0',
  'icons/badge-96.png',
  'js/calc.js?v=0.11.0',
  'js/charts.js?v=0.11.0',
  'js/messages.js?v=0.11.0',
  'js/store.js?v=0.11.0',
