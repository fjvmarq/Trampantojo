...
const CACHE = 'trampantojo-0.11.1';
...
const FILES = [
  './',
  'index.html',
  'css/app.css?v=0.11.1',
  'js/app.js?v=0.11.1',
  'js/ambient.js?v=0.11.1',
  'js/foods.js?v=0.11.1',
  'js/comidas.js?v=0.11.1',
  'js/antojo.js?v=0.11.1',
  'js/antojo-ui.js?v=0.11.1',
  'js/ideas.js?v=0.11.1',
  'js/logros.js?v=0.11.1',
  'js/calidad.js?v=0.11.1',
  'js/cuerpo.js?v=0.11.1',
  'js/ejercicio.js?v=0.11.1',
  'js/copia.js?v=0.11.1',
  'js/agua.js?v=0.11.1',
  'js/menu.js?v=0.11.1',
  'js/calendario.js?v=0.11.1',
  'js/fotos.js?v=0.11.1',
  'icons/badge-96.png',
  'js/calc.js?v=0.11.1',
  'js/charts.js?v=0.11.1',
  'js/messages.js?v=0.11.1',
  'js/store.js?v=0.11.1',
